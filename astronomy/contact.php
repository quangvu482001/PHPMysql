			...
			<div class="main">
				...
				<?php 
					...
					if(isset($_POST['submit'])){
						$insert = $get_data -> in_contact($_POST['txtName'], $_POST['txtEmail'], $_POST['txtSubject'], $_POST['txtMessage'], $_POST['txtTerm'], $_POST['txtSubscrice']); // -> call function in_contact from class data
