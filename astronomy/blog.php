			...
			?>
				...
				<ul class="list">
					...
					<li>
						...
						<!-- truyền sang trang fullBlog.php với giá trị truyền là chữ content,
							Gía trị truyền dc gán = ID của bài viết
					-->
						<a href="fullBlog.php?content=<?php  echo $se['ID']?>" class="more">Read more&gt;&gt;</a>
					</li>
